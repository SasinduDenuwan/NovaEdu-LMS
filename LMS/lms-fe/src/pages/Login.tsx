      ...
      <div className="w-full max-w-md">
        ...
        <div className="relative bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 transform transition-all duration-500 hover:shadow-3xl">
          ...
          <div className="text-center mb-8 animate-fade-in">
            <div className="inline-block p-4 rounded-2xl mb-4 shadow-lg transform transition-transform hover:rotate-12 duration-300" style={{background: 'linear-gradient(135deg, #14B8A6 0%, #2563EB 100%)'}}>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center cursor-pointer group">
                ...
                />
                <span className="ml-2 text-gray-600 group-hover:text-[#0D9488] transition-colors">
                  Remember me
                </span>
              </label>
              <Link to="/forgot-pw" className="text-[#14B8A6] hover:text-[#0D9488] font-medium transition-colors">
                Forgot password?
              </Link>
            </div>
